function plotStochastic_SCI_2(simData,numPlots,popSize,tFinal,newFigure)
...
for i = 1:numPlots
    ...
    plot(selectedSimData{i,1},selectedSimData{i,4});
    plot(selectedSimData{i,1},selectedSimData{i,5});
end
